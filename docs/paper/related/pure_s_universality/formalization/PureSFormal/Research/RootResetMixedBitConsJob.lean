...
namespace PureSFormal.Research.RootResetMixedBitConsJob
...
theorem completeJob_selectorChain
  ...
  | succ remaining =>
      ...
      obtain ⟨witnessTerminal, witnessConfigurations, witnessChain, witnessSelected, witnessLength⟩ :=
        RootResetMixedFirstEmptyJob.selectedSweepWitness program dispatcher bits stage jobs jobsBound parents layers clean remaining
...
end PureSFormal.Research.RootResetMixedBitConsJob
