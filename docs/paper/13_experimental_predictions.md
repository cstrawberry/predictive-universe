...
* To detect $\Delta P = 1 \times 10^{-3}$:
      $N_{\mathrm{total}}\approx 1.0\times 10^{7}$ (two\text{-}sample) or $N\approx 2.5\times 10^{6}$ (one\text{-}sample).
* To detect $\Delta P = 5 \times 10^{-4}$:
     $N_{\mathrm{total}}\approx 4.0\times 10^{7}$ (two\text{-}sample) or $N\approx 1.0\times 10^{7}$ (one\text{-}sample).
* To detect $\Delta P = 1 \times 10^{-4}$:
     $N_{\mathrm{total}}\approx 1.0\times 10^{9}$ (two\text{-}sample) or $N\approx 2.5\times 10^{8}$ (one\text{-}sample).
