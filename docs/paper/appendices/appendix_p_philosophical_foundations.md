...
| Emergent metric / Einstein equation | $G_{\mu\nu}+\Lambda g_{\mu\nu}=8\pi G T_{\mu\nu}^{(\mathrm{MPU})}$ | Theorem 48a; Theorem 12.1; Corollary 12.1b; Theorem 12.1c; Theorem 12.5.3f; Corollary 12.5.3g; Theorem 12.5.3h | closed on the accepted finite KMS-descent branch as an emergent finite-response equation of state; modular-QNEC closure requires zero retained slack in every local null direction |
...
| Environmental SPAP passive tier | hard-core perspective Gibbs kernel | Definition 14.5.8e; Theorem 14.5.8f; Corollary 14.5.8g; Propositions 14.5.8b--14.5.8d; Theorem M.10.3; Corollary M.10.4.1 | theorem-level only on the hard-core perspective Gibbs branch; outside that datum the passive tier remains conditional model-layer because cost-gradient bias and weak limits do not imply support exclusion |
| Dark-sector response kernels | acceleration bridge plus galaxy and cluster kernels | Definition H.4.2.8a; Theorem H.4.2.8b; Corollary H.4.2.8c; Equation I.4; Equations I.7--I.8; Theorem I.5 | acceleration scale closed on the bridge branch; $(L_0,A_G,m)$ and $(K,q,A_{\mathrm{PM}})$ remain phenomenological until derived from microscopic relaxation or a covariant susceptibility |
...
| Recurrent integer subledger | three-chain decomposition of $(K_0,d_0,\varepsilon_0,a,b,M,k,D)$ | Proposition T.59; Corollary T.59a; Proposition R.3.5e; Remark R.3.5e.1; Theorem R.3.5e.3; Corollary R.3.5e.4 | closed as a decomposition theorem; no single-source compression is claimed without an additional parent-invariant theorem |
...
|:---------|:--------------------|:-------------------|:----------|:----------|
| $\alpha^{-1}$ | $\alpha^{-1}_{0}=137.03609205522863\ldots$; $\alpha^{-1}_{\mathrm{cert}}=\alpha^{-1}_{0}+R_\alpha$ | $137.035999177(21)$ | NIST 2024; CODATA 2022; Appendix Z | certificate-pending on residual gate |
