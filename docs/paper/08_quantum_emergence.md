...
*Proof.* Theorem 8.7 yields a strongly continuous unitary group $U(t)=e^{-i\hat Ht/\hbar}$ implementing the Internal Prediction dynamics on $\mathcal H_0$. For every initial vector $S(0)=|\psi_0\rangle\in D(\hat H)$,
$$
