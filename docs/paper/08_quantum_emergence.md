...
Let $\omega:\mathfrak A\to\mathbb C$ be a *predictive state* (as per the principles of Section 2), defined as a linear, positive ($\omega(a^{\!*}a)\ge0$), normalized ($\omega(\mathbf 1)=1$), and continuous functional in the cost‑norm.
