...
*   **Three-Chain Dependency Separation:** (Appendix R, Proposition R.3.5e.2; Theorem R.3.5e.3; Corollary R.3.5e.4; Remarks R.3.5e.5 and R.3.5e.6) Decomposition of the recurrent integer subledger into capacity, Peirce tangent, and kissing-number proof roles. The current ledger proves non-collapse of these roles; it does not prove pairwise-disjoint leaf inputs or a no-go theorem against a future common parent structure.
