...
*   **Spectral Branch Package:** (Theorem T.78.2) The additional data needed to turn the structurally formulated flag-lift threshold problem on $\widetilde X$ into a completed numerical block-sum computation: metric normalization, connection, structural parameters, sector/parity block data, and explicit tail certificates.
