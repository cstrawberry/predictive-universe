...
**4.3.2a Remark 2a (Generative Non-Closure Reading of SPAP/RUD).** SPAP and RUD do not merely add incompleteness to an otherwise complete axiom system. On the conservative reading formalized in Appendix A.6 and Appendix P.16c, they establish the impossibility of total internal reflexive self-closure for any sufficiently rich embedded predictor. The admissible response is not to complete the system by a stronger internal truth predicate, but to form stable finite partial closures: verification predicates, typing boundaries, acceptance cuts, resource gates, PCE quotients, and PPI instantiation rules. In this sense the framework uses incompleteness as a generator of axiom-like stabilizers rather than as an additional axiom contained inside a closed formal system.
